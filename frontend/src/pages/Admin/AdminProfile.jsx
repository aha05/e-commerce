    ...
    return (
        <div>
            <Container className="container profile-container my-5 mx-5">
                <div className="justify-content-center" style={{ marginLeft: "50px", marginRight: "150px" }}>
                        ...
                        <Col md={9}>
                            <div className="d-flex justify-content-between align-items-start">
                                ...
                                <div>
                                    ...
                                    <p><span className="text-muted">Username:</span> {user.username}</p>
                                    <p><span className="text-muted">Email:</span> {user.email}</p>
                                    <p><span className="text-muted">Phone:</span> {user.phone}</p>
                                    <p><span className="text-muted">Country:</span> {user?.address?.country}</p>
                                    <p><span className="text-muted">Address:</span> {user?.address?.address}</p>
                                </div>
